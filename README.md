...
## OUTPUT:
<img width="1796" height="233" alt="image" src="https://github.com/user-attachments/assets/a739c737-2170-4407-814d-bce5a2a8d3d6" />


## RESULT:
The host took 0.829219 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.025832 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
